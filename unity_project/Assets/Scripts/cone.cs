...
public class cone : MonoBehaviourPun
{
    ...
    public ConeType coneType = ConeType.afm;
    ...
    void OnDrawGizmos()
    {
        ...
        if (c == null) return;
        foreach (Vector3 direction in c.directions)
        {
...
public class ConeVectors
{
    ...
    // public static ConeVectors ImportIsoGaze(TextAsset jsonString)
